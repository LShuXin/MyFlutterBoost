            ...
            body: SingleChildScrollView(
                child: Container(
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                            Container(
                              margin: const EdgeInsets.only(left: 8.0, top: 10.0, bottom: 20.0),
                              child: RichText(
                            ...
                            InkWell(
                                ...
                                onTap: () => BoostNavigator.instance
                                    ...
                                    .then((value) => print('xlog, mediaquery, Return Value:$value'),
                                ),
                            ),
                            InkWell(
                              child: Container(
                            ...
                            InkWell(
                                ...
                                onTap: () => BoostNavigator.instance
                                    ...
                                    .then((value) => print('xlog, webview, Return Value:$value'),
                                ),
                            ),
                            InkWell(
                                child: Container(
                            ...
                            InkWell(
                                ...
                                onTap: () => BoostNavigator.instance.push("system_ui_overlay_style", withContainer: withContainer),
                            ),
                            InkWell(
                              child: Container(
                                  padding: const EdgeInsets.all(8.0),
                              ...
                              onTap: () {
                                  ...
                                  ).then((value) => print('xlog, PushWidget, Return Value: $value'));
                              },
                            ),
                            InkWell(
                                child: Container(
                                ...
                                onTap: () => BoostNavigator.instance.push("returnData", withContainer: withContainer)
                            ),
                            InkWell(
                                child: Container(
                                    padding: const EdgeInsets.all(8.0),
                                ...
                                onTap: () {
                                    BoostNavigator.instance.push("transparentWidget", withContainer: withContainer, opaque: false);
                                },
                            ),
                            InkWell(
                                child: Container(
                                ...
                                onTap: () => BoostNavigator.instance.push("radialExpansion", withContainer: withContainer),
                            ),
                            InkWell(
                                child: Container(
                                    padding: const EdgeInsets.all(8.0),
                                ...
                                onTap: () {
                                  BoostNavigator.instance.push('popUntilView', withContainer: withContainer);
                                },
                            ),
                            InkWell(
                                child: Container(
                                ...
                                onTap: () {
                                    BoostNavigator.instance.push('flutterRebuildDemo', withContainer: withContainer);
                                },
                            ),
                        ],
                    ),
